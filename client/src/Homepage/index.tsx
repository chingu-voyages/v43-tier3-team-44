...
const Homepage = () => {
  return (
    <main className="h-96 flex flex-col">
      <h1 className="font-header text-5xl text-br-red">
        Welcome to DM Assistant
      </h1>
      <div className="experiences flex flex-col mt-14">
        <a
          href="/encounter-generator"
          className="font-header underline decoration-1 underline-offset-4 text-3xl text-white"
        >
